...
public class GetRequest21TestData extends JsonPalaceHolderBaseUrl {
    /*
   ...
   */
    ...
    public void test21(){
        ...
        //1) URL OLUSTUR
        speq04.pathParams("1", "todos", "2", 2);

        //2) EXPECTED DATA OLUSTUR

        JasonPlaceHolderTestData expectedDataObje = new JasonPlaceHolderTestData();
        ...
        Response response = given().spec(speq04).when().get("/{1}/{2}");
